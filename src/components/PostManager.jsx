//in this code we can add post this code paste in admin dailypost
...
//   return (
//     <div className="relative max-w-6xl mx-auto p-6 bg-white shadow-md rounded-md mt-[20vh]">
...
const PostManager = () => {
  ...
  return (
    <div className="relative max-w-6xl mx-auto p-6 bg-white shadow-md rounded-md">
      <h1 className="text-2xl font-bold mb-6 text-gray-800">Daily Darshan</h1>
